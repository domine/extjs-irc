...
Ext.ux.IRC.Channel = Ext.extend(Ext.util.Observable, {
   ...
   * @param {Ext.ux.IRC.Manager} manager The Ext.ux.IRC.Manager administering this channel
   */
  constructor: function(name, manager) {
    /**
     * @property name
     * @type String
     ...
     * The IRC Manager this channel is a member of
     */
    ...
    this.onIfThisChannel(this.manager.proxy, {
  ...
  sendMessage: function(message) {
    this.manager.proxy.sendPrivMsg(this.name, message);
  },
